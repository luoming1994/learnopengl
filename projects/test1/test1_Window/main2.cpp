...
void InitGlew();
GLFWwindow* CreateGlewWindow(int width, int hight, const char* title, GLFWframebuffersizefun framebuffer_size_callback);
void CloseGlew();
bool LoadGlad();
...
int main2()
{
	...
	glVertexAttribPointer(vt, vs, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
